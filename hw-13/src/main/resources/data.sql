...
insert into users (id,username,password) values (1,'admin','admin_password')
insert into users (id,username,password) values (2,'user','user_password')

insert into user_role (user_id,role_set) values (1,'ADMIN')
insert into user_role (user_id,role_set) values (2,'USER')